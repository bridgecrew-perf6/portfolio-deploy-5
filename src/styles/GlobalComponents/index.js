...
export const SectionDivider = styled.div`
  ...
  background: ${(props) => props.colorAlt ?
    'linear-gradient(270deg, #F1DAC4 0%, #7477AA 100%)' :
    'linear-gradient(270deg, #A69CAC 0%, #7477AA 100%)'};
...
export const ButtonBack = styled.div`
  ...
  color: #fff;
  background: ${({ alt }) => alt ? 'linear-gradient(270deg, #F1DAC4 0%, #7477AA 100%)' : 'linear-gradient(270deg, #A69CAC 0%, #7477AA 100%)'};
  cursor: pointer;
...
export const ButtonFront = styled.button`
  ...
  width: 100%;
  height: 100%;
  background: ${({ alt }) => alt ? 'linear-gradient(270deg, #F1DAC4 0%, #474973 100%)' : 'linear-gradient(270deg, #7D6F85 0%, #474973 100%)'};
  opacity: ${({ disabled }) => disabled ? '.5' : '1'};
  transition: .4s ease;
  font-size: ${({ alt }) => alt ? '20px' : '24px'};
  font-weight: 600;
  ...
  &:disabled{
    background: linear-gradient(270deg, #A69CAC 0%, #7477AA 100%);
    opacity: 0.5;
    box-shadow: inset 0px 2px 1px rgba(46, 49, 55, 0.15), inset 0px 0px 4px rgba(20, 20, 55, 0.3);
  }
